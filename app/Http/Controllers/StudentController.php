...
class StudentController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        $student->update([
            ...
            'marital_status' => $data['maritalStatus'] ?? $student->marital_status,
            'blood_type' => $data['bloodType'] ?? $student->blood_type,
            'pob' => $data['pob'] ?? $student->pob,
            'citizenship' => $data['citizenship'] ?? $student->citizenship,
            'race' => $data['race'] ?? $student->race,
            'religion' => $data['religion'] ?? $student->religion,
            'education_background' => $data['educationBackground'] ?? $student->education_background,
            'emergency_contact_name' => $data['emergencyContactName'] ?? $student->emergency_contact_name,
            'emergency_contact_phone' => $data['emergencyContactPhone'] ?? $student->emergency_contact_phone,
            'family_income' => $data['familyIncome'] ?? $student->family_income,
