...
export function TeacherAIAssessment() {
  const [results] = useState<AIResult[]>([
    { id: '1', studentName: 'Ahmad Zulkifli', surah: 'Al-Fatihah', score: 94, date: '2026-04-03', status: 'pending' },
    { id: '2', studentName: 'Siti Aminah', surah: 'Al-Mulk', score: 88, date: '2026-04-02', status: 'reviewed' },
    { id: '3', studentName: 'Omar Mokhtar', surah: 'An-Naba', score: 72, date: '2026-04-02', status: 'reviewed' },
    { id: '4', studentName: 'Fatimah Az-Zahra', surah: 'Al-Kahfi', score: 91, date: '2026-04-01', status: 'pending' },
  ]);
        ...
        {filteredResults.map((r) => (
          <div key={r.id} className="bg-white p-5 rounded-[24px] border border-slate-100 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6 hover:shadow-md transition-shadow group">
            ...
            <div className="flex items-center gap-12">
              ...
              <div className="flex items-center gap-2">
                 {r.status === 'pending' ? (
                   <button className="px-5 py-2.5 bg-[#1A4D50] text-white rounded-xl text-xs font-bold hover:bg-slate-900 transition-all shadow-lg flex items-center gap-2">
